...
<div id="navbar">
  ...
  <a class="active" href="drawings.php">Drawings</a>
  ...
  if ($_COOKIE["login"] == 0) {
	  ...
	  $u_na = $_COOKIE["uname"];
	  echo "<table><td><a>$u_na</a></td><td><form action='drawings.php' method='post'><input type='hidden' id='u_status' name='u_status' value='0'><button type='submit'>Log out</button></form></td>
	  <td><button  onclick=window.location.href='settings.php'>Settings</button></td></table>";
  }
  ?>
  </div>
